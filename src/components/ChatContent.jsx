          ...
          {message.image_id && (
            <div className="mt-2">
              <img
                ...
                src={`https://syncserviceswhatsappbackend-production.up.railway.app/image/${message.image_id}.jpg`}  // Replace with actual image URL
                alt="Message"
            ...
            <div className="mt-2">
              ...
              >
                <source
                  ...
                  src={`https://syncserviceswhatsappbackend-production.up.railway.app//video/${message.video_id}.mp4`}  // Replace with actual video URL
                  type="video/mp4"
                />
